...
bool RedisControl::HashMapSet(const std::string& key, std::unordered_map<std::string, std::string> hashMap, const uint64_t time)
{
    try
    {
...
const OptionalString RedisControl::Get(const std::string& key)
{
...
bool RedisControl::Exist(const std::string& key)
{
    bool retval;
    try
    {
...
bool RedisControl::Delete(const std::string& key)
{
    bool retval;
    try
    {
