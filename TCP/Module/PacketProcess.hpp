...
protected:
    ...
    PacketResult NULL_PACKET_METHOD(FuncElement& param)
    {
...
{
public:
    using ProcessHandler = PacketResult(PacketProcess::*)(NetElement&);
...
private:
    ...
    PacketResult HelloNewSession(NetElement& param);
public:
